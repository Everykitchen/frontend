...
const StatusBadge = styled.div`
    ...
    background-color: ${(props) =>
        props.status === "진행중" ? "#FFBC39" : "#9B9B9B"};
    color: white;
    border-radius: 4px;
    font-size: 14px;
    font-weight: 500;
        ...
        const fetchReservations = async () => {
            ...
            try {
                const res = await axios.get(
                    "/api/host/reservation?page=0&size=200"
                );
                setReservations(res.data.content || []);

                // 예약이 있는 날짜들 추출
                const dates = (res.data.content || []).map(
            ...
            >
                <button
                    ...
                    style={{
                        ...
                        border: "none",
                        fontSize: 24,
                        color: prevMonthButtonDisabled ? "#eee" : "#ffbc39",
                ...
                <button
                    ...
                    style={{
                        ...
                        border: "none",
                        fontSize: 24,
                        color: nextMonthButtonDisabled ? "#eee" : "#ffbc39",
        ...
        <Container>
            ...
            <ContentWrapper>
                <PageHeader>
                    <Title>예약 달력</Title>
                    <BackButton
                        onClick={() => navigate("/host-mypage/reservations")}
                    >
                        목록으로 돌아가기
                    </BackButton>
                </PageHeader>
                        ...
                        {loading ? (
                            ...
                            selectedDateReservations.map((reservation) => (
                                ...
                                >
                                    <KitchenImage
                                        src={
                                            reservation.imageUrl || kitchenImage
                                        }
                                        alt="주방 이미지"
