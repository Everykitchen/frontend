...
const ReservationCard = ({ reservation }) => {
    ...
    return (
        <Card onClick={() => navigate(`/mypage/reservations/${reservation.reservationId}`)}>
            <KitchenImage
            ...
            <ContentWrapper>
                <ReservationInfo>
                    <ReservationNumber>예약번호 {reservation.reservationId}</ReservationNumber>
                    <KitchenName>{reservation.kitchenName}</KitchenName>
                    <Location>{formatLocation(reservation.kitchenLocation)}</Location>
                    <DateTime>{reservation.reservationDate} {reservation.reservationTime} ({reservation.clientNumber}인)</DateTime>
